      ...
      <div className="corporative-sales-page p-5">
        <div className="content container">
          ...
          <div className="info mt-5">
            <p>
              We sell various types of high-quality digital and household
              appliances, as well as furniture. The number of our corporate
              clients has already exceeded 2000 and continues to grow every day.
            </p>

            <p className="mt-5">
              We offer you the following opportunities for cooperation:
            </p>

            <ol>
              <li>Credit sales for corporate clients;</li>
              <li>
                Transportation of all office equipment, such as: telephone,
                laptop, air conditioner, microwave oven, dispenser, etc., by
                transfer;
              </li>
              <li>Making payments by transfer in cooperation with us;</li>
              <li>Special discounts for companies with which we cooperate;</li>
              <li>
                Purchasing goods on order, in addition to those presented on our
                website.
              </li>
            ...
            <p className="contact">
              For cooperation, please contact us in any way convenient for you,
              as indicated below:
            </p>
