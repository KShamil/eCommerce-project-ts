...
const SaleCard: React.FC<SaleCardType> = React.memo(
  ({ id, img, title, price, rating, salePrice, addProduct, addWishlist }) => {
    ...
    return (
      <>
        <div
          className="card-body position-relative border border-muted bg-body p-3"
        ...
        >
          ...
          <h2 className="fs-6">
            <span className="text-inherit text-dark" tabIndex={-1}>
          ...
          <div className="d-flex justify-content-between align-items-center mt-3">
            ...
            <div>
              <span className="badge bg-success small text-white">
                In Stock
              </span>
            </div>
          </div>
