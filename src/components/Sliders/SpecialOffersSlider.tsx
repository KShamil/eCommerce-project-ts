...
const SpecialOffersSlider = () => {
  ...
  return (
    <div className='special-offers container mt-5'>
        ...
        <Link to="/specialoffers" className='btn btn-outline-danger rounded-0 w-100 d-flex justify-content-center align-items-center p-3 fw-bold'>{t("changeBtnLanguage.showmorebtn")}</Link>
    </div>
  )
}
